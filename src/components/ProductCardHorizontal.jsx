        ...
        <div class="card-horizontal d-flex shadow">
            ...
            <div class="card-details d-flex direction-column">
                ...
                <div class="cta-btn d-flex gap">
                    ...
                    <div class="cta-btn">
                        <button onClick={(lets)=>{removethis(lets,id)}} class="button hori-btn btn-outline-primary btn-icon d-flex align-center justify-center gap cursor btn-margin">
                        Remove</button>
                    </div>
                </div>
            </div>
